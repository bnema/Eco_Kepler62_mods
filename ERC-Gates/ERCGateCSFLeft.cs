...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ERCGateCSFLeftObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(ERCGateCSFLeftItem);
        public override LocString DisplayName => Localizer.DoStr("Corrugated Steel Fence Gate - Left");
		...
		static ERCGateCSFLeftObject()
        {
            WorldObject.AddOccupancy<ERCGateCSFLeftObject>(new List<BlockOccupancy>(){
    ...
    [Serialized]
    [LocDisplayName("Corrugated Steel Fence Gate - Left")]
    [Tier(3)]
	
        public partial class ERCGateCSFLeftItem : WorldObjectItem<ERCGateCSFLeftObject>
    {
    ...
    public partial class ERCGateCSFLeftRecipe : RecipeFamily
    {
        public ERCGateCSFLeftRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "ERCGateCSFLeft",  //noloc
                Localizer.DoStr("Corrugated Steel Fence Gate - Left"),
                ...
                {
                    new CraftingElement<ERCGateCSFLeftItem>()
                });
            this.Recipes = new List<Recipe> { recipe };
            this.ExperienceOnCraft = 5;
            this.LaborInCalories = CreateLaborInCaloriesValue(480, typeof(AdvancedSmeltingSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(ERCGateCSFLeftRecipe), 10, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Corrugated Steel Fence Gate - Left"), typeof(ERCGateCSFLeftRecipe));
            this.ModsPostInitialize();
