...
namespace Eco.Mods.TechTree
{
    ...
    public partial class ERCGateCSWRightObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(ERCGateCSWRightItem);
        public override LocString DisplayName => Localizer.DoStr("Corrugated Steel Wall Gate - Right");
		...
		static ERCGateCSWRightObject()
        {
            WorldObject.AddOccupancy<ERCGateCSWRightObject>(new List<BlockOccupancy>(){
    ...
    [Serialized]
    [LocDisplayName("Corrugated Steel Wall Gate - Right")]
    [Tier(3)]
	
        public partial class ERCGateCSWRightItem : WorldObjectItem<ERCGateCSWRightObject>
    {
    ...
    public partial class ERCGateCSWRightRecipe : RecipeFamily
    {
        public ERCGateCSWRightRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                "ERCGateCSWRight",  //noloc
                Localizer.DoStr("Corrugated Steel Wall Gate - Right"),
                ...
                {
                    new CraftingElement<ERCGateCSWRightItem>()
                });
            this.Recipes = new List<Recipe> { recipe };
            this.ExperienceOnCraft = 5;
            this.LaborInCalories = CreateLaborInCaloriesValue(480, typeof(AdvancedSmeltingSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(ERCGateCSWRightRecipe), 10, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingFocusedSpeedTalent), typeof(AdvancedSmeltingParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(Localizer.DoStr("Corrugated Steel Wall Gate - Right"), typeof(ERCGateCSWRightRecipe));
            this.ModsPostInitialize();
