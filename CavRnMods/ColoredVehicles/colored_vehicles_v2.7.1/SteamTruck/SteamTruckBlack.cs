namespace Eco.Mods.TechTree
{
    ...
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A black truck that runs on steam."); } }
        [Serialized, SyncToView, TooltipChildren, ] public object PersistentData { get; set; }
    }
    
      
    public class PaintSteamTruckBlackRecipe : RecipeFamily
    {
        public PaintSteamTruckBlackRecipe()
        {
            ...
            {
                new Recipe(
                    "Paint Steam Truck Black",
                    Localizer.DoStr("Paint Steam Truck Black"),
                    new IngredientElement[]
                    {
                        new IngredientElement(typeof(SteamTruckItem), 1, true), 
                        new IngredientElement(typeof(ShaleItem), 40, typeof(MechanicsSkill), typeof(MechanicsLavishResourcesTalent)),
                    },
                    new CraftingElement<SteamTruckBlackItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(MechanicsSkill)); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintSteamTruckBlackRecipe), 10, typeof(MechanicsSkill));    

            this.Initialize(Localizer.DoStr("Paint Steam Truck Black"), typeof(PaintSteamTruckBlackRecipe));
    ...
    public partial class SteamTruckBlackObject : PhysicsWorldObject, IRepresentsItem
    {
        ...
        public override LocString DisplayName { get { return Localizer.DoStr("Steam Truck Black"); } }
        public Type RepresentedItemType { get { return typeof(SteamTruckBlackItem); } }
