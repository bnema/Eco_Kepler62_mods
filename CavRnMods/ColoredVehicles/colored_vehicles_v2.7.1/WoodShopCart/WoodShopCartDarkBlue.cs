namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Wood Shop Cart DarkBlue")]
    [Weight(15000)]
    [Tag("ColoredWoodShopCart")]
    [Ecopedia("CavRnMods", "Colored Vehicles", createAsSubPage: true)]
    public partial class WoodShopCartDarkBlueItem : WorldObjectItem<WoodShopCartDarkBlueObject>, IPersistentData
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A store in a DarkBlue wooden cart, very useful when your customers are far away."); } }
        [Serialized, SyncToView, TooltipChildren] public object PersistentData { get; set; }
    }

    public class PaintWoodShopCartDarkBlueRecipe : RecipeFamily
    {
        public PaintWoodShopCartDarkBlueRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Paint Wood Shop Cart DarkBlue",
                    Localizer.DoStr("Paint Wood Shop Cart DarkBlue"),
                    new IngredientElement[]
                    {
                        ...
                        new IngredientElement(typeof(ShaleItem), 16, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                    },
                    new CraftingElement<WoodShopCartDarkBlueItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(BasicEngineeringSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodShopCartDarkBlueRecipe), 10, typeof(BasicEngineeringSkill));

            this.Initialize(Localizer.DoStr("Paint Wood Shop Cart DarkBlue"), typeof(PaintWoodShopCartDarkBlueRecipe));
    ...
    public partial class WoodShopCartDarkBlueObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodShopCartDarkBlueObject()
        {
            WorldObject.AddOccupancy<WoodShopCartDarkBlueObject>(new List<BlockOccupancy>(0));
        }

        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Shop Cart DarkBlue"); } }
        public Type RepresentedItemType { get { return typeof(WoodShopCartDarkBlueItem); } }


        private WoodShopCartDarkBlueObject() { }
    ...
    /// <summary> This represents wood shop cart. It's a special shop which you can move by pulling it. Implements IFreezable, so when nobody pull it, it won't move anyway. </summary>
        ...
        public partial class WoodShopCartDarkBlueObject : PhysicsWorldObject, INullCurrencyAllowed, IGameActionAware, IFreezable
        {
    #region IFreezable
