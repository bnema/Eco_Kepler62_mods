namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Wood Shop Cart Pink")]
    [Weight(15000)]
    [Tag("ColoredWoodShopCart")]
    [Ecopedia("CavRnMods", "Colored Vehicles", createAsSubPage: true)]
    public partial class WoodShopCartPinkItem : WorldObjectItem<WoodShopCartPinkObject>, IPersistentData
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A store in a Pink wooden cart, very useful when your customers are far away."); } }
        [Serialized, SyncToView, TooltipChildren] public object PersistentData { get; set; }
    }

    public class PaintWoodShopCartPinkRecipe : RecipeFamily
    {
        public PaintWoodShopCartPinkRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Paint Wood Shop Cart Pink",
                    Localizer.DoStr("Paint Wood Shop Cart Pink"),
                    new IngredientElement[]
                    {
                        new IngredientElement(typeof(WoodShopCartItem), 1, true),
                        new IngredientElement(typeof(BeetItem), 24, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                        new IngredientElement(typeof(LimestoneItem), 16, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                    },
                    new CraftingElement<WoodShopCartPinkItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(BasicEngineeringSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodShopCartPinkRecipe), 10, typeof(BasicEngineeringSkill));

            this.Initialize(Localizer.DoStr("Paint Wood Shop Cart Pink"), typeof(PaintWoodShopCartPinkRecipe));
    ...
    public partial class WoodShopCartPinkObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodShopCartPinkObject()
        {
            WorldObject.AddOccupancy<WoodShopCartPinkObject>(new List<BlockOccupancy>(0));
        }

        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Shop Cart Pink"); } }
        public Type RepresentedItemType { get { return typeof(WoodShopCartPinkItem); } }


        private WoodShopCartPinkObject() { }
    ...
    /// <summary> This represents wood shop cart. It's a special shop which you can move by pulling it. Implements IFreezable, so when nobody pull it, it won't move anyway. </summary>
        ...
        public partial class WoodShopCartPinkObject : PhysicsWorldObject, INullCurrencyAllowed, IGameActionAware, IFreezable
        {
    #region IFreezable
