namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Wood Shop Cart Yellow")]
    [Weight(15000)]
    [Tag("ColoredWoodShopCart")]
    [Ecopedia("CavRnMods", "Colored Vehicles", createAsSubPage: true)]
    public partial class WoodShopCartYellowItem : WorldObjectItem<WoodShopCartYellowObject>, IPersistentData
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A store in a Yellow wooden cart, very useful when your customers are far away."); } }
        [Serialized, SyncToView, TooltipChildren] public object PersistentData { get; set; }
    }

    public class PaintWoodShopCartYellowRecipe : RecipeFamily
    {
        public PaintWoodShopCartYellowRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Paint Wood Shop Cart Yellow",
                    Localizer.DoStr("Paint Wood Shop Cart Yellow"),
                    new IngredientElement[]
                    {
                        new IngredientElement(typeof(WoodShopCartItem), 1, true),
                        new IngredientElement(typeof(PineappleItem), 40, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                    },
                    new CraftingElement<WoodShopCartYellowItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(BasicEngineeringSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodShopCartYellowRecipe), 10, typeof(BasicEngineeringSkill));

            this.Initialize(Localizer.DoStr("Paint Wood Shop Cart Yellow"), typeof(PaintWoodShopCartYellowRecipe));
    ...
    public partial class WoodShopCartYellowObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodShopCartYellowObject()
        {
            WorldObject.AddOccupancy<WoodShopCartYellowObject>(new List<BlockOccupancy>(0));
        }

        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Shop Cart Yellow"); } }
        public Type RepresentedItemType { get { return typeof(WoodShopCartYellowItem); } }


        private WoodShopCartYellowObject() { }
    ...
    /// <summary> This represents wood shop cart. It's a special shop which you can move by pulling it. Implements IFreezable, so when nobody pull it, it won't move anyway. </summary>
        ...
        public partial class WoodShopCartYellowObject : PhysicsWorldObject, INullCurrencyAllowed, IGameActionAware, IFreezable
        {
    #region IFreezable
