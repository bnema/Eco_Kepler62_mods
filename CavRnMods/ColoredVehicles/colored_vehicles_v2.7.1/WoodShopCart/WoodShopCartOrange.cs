namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Wood Shop Cart Orange")]
    [Weight(15000)]
    [Tag("ColoredWoodShopCart")]
    [Ecopedia("CavRnMods", "Colored Vehicles", createAsSubPage: true)]
    public partial class WoodShopCartOrangeItem : WorldObjectItem<WoodShopCartOrangeObject>, IPersistentData
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A store in a Orange wooden cart, very useful when your customers are far away."); } }
        [Serialized, SyncToView, TooltipChildren] public object PersistentData { get; set; }
    }

    public class PaintWoodShopCartOrangeRecipe : RecipeFamily
    {
        public PaintWoodShopCartOrangeRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Paint Wood Shop Cart Orange",
                    Localizer.DoStr("Paint Wood Shop Cart Orange"),
                    new IngredientElement[]
                    {
                        new IngredientElement(typeof(WoodShopCartItem), 1, true),
                        new IngredientElement(typeof(SandstoneItem), 40, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                    },
                    new CraftingElement<WoodShopCartOrangeItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(BasicEngineeringSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodShopCartOrangeRecipe), 10, typeof(BasicEngineeringSkill));

            this.Initialize(Localizer.DoStr("Paint Wood Shop Cart Orange"), typeof(PaintWoodShopCartOrangeRecipe));
    ...
    public partial class WoodShopCartOrangeObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodShopCartOrangeObject()
        {
            WorldObject.AddOccupancy<WoodShopCartOrangeObject>(new List<BlockOccupancy>(0));
        }

        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Shop Cart Orange"); } }
        public Type RepresentedItemType { get { return typeof(WoodShopCartOrangeItem); } }


        private WoodShopCartOrangeObject() { }
    ...
    /// <summary> This represents wood shop cart. It's a special shop which you can move by pulling it. Implements IFreezable, so when nobody pull it, it won't move anyway. </summary>
        ...
        public partial class WoodShopCartOrangeObject : PhysicsWorldObject, INullCurrencyAllowed, IGameActionAware, IFreezable
        {
    #region IFreezable
