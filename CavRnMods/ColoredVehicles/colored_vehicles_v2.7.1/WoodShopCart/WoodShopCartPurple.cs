namespace Eco.Mods.TechTree
{
    ...
    [Serialized]
    [LocDisplayName("Wood Shop Cart Purple")]
    [Weight(15000)]
    [Tag("ColoredWoodShopCart")]
    [Ecopedia("CavRnMods", "Colored Vehicles", createAsSubPage: true)]
    public partial class WoodShopCartPurpleItem : WorldObjectItem<WoodShopCartPurpleObject>, IPersistentData
    {
        public override LocString DisplayDescription { get { return Localizer.DoStr("A store in a Purple wooden cart, very useful when your customers are far away."); } }
        [Serialized, SyncToView, TooltipChildren] public object PersistentData { get; set; }
    }

    public class PaintWoodShopCartPurpleRecipe : RecipeFamily
    {
        public PaintWoodShopCartPurpleRecipe()
        {
            this.Recipes = new List<Recipe>
            {
                new Recipe(
                    "Paint Wood Shop Cart Purple",
                    Localizer.DoStr("Paint Wood Shop Cart Purple"),
                    new IngredientElement[]
                    {
                        new IngredientElement(typeof(WoodShopCartItem), 1, true),
                        new IngredientElement(typeof(BeetItem), 40, typeof(BasicEngineeringSkill), typeof(BasicEngineeringLavishResourcesTalent)),
                    },
                    new CraftingElement<WoodShopCartPurpleItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;
            this.LaborInCalories = CreateLaborInCaloriesValue(500, typeof(BasicEngineeringSkill));
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodShopCartPurpleRecipe), 10, typeof(BasicEngineeringSkill));

            this.Initialize(Localizer.DoStr("Paint Wood Shop Cart Purple"), typeof(PaintWoodShopCartPurpleRecipe));
    ...
    public partial class WoodShopCartPurpleObject : PhysicsWorldObject, IRepresentsItem
    {
        static WoodShopCartPurpleObject()
        {
            WorldObject.AddOccupancy<WoodShopCartPurpleObject>(new List<BlockOccupancy>(0));
        }

        public override TableTextureMode TableTexture => TableTextureMode.Wood;
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Shop Cart Purple"); } }
        public Type RepresentedItemType { get { return typeof(WoodShopCartPurpleItem); } }


        private WoodShopCartPurpleObject() { }
    ...
    /// <summary> This represents wood shop cart. It's a special shop which you can move by pulling it. Implements IFreezable, so when nobody pull it, it won't move anyway. </summary>
        ...
        public partial class WoodShopCartPurpleObject : PhysicsWorldObject, INullCurrencyAllowed, IGameActionAware, IFreezable
        {
    #region IFreezable
