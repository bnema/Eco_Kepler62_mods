namespace Eco.Mods.TechTree
{
    ...
    public class PaintWoodCartDarkBlueRecipe : RecipeFamily
    {
        public PaintWoodCartDarkBlueRecipe()
        {
            ...
            {
                new Recipe(
                    "Paint Wood Cart DarkBlue",
                    Localizer.DoStr("Paint Wood Cart DarkBlue"),
                    ...
                    new CraftingElement<WoodCartDarkBlueItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;  
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(BasicEngineeringSkill)); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintWoodCartDarkBlueRecipe), 5, typeof(BasicEngineeringSkill));    

            this.Initialize(Localizer.DoStr("Paint Wood Cart DarkBlue"), typeof(PaintWoodCartDarkBlueRecipe));
    ...
    public partial class WoodCartDarkBlueObject : PhysicsWorldObject, IRepresentsItem
    {
        ...
        public override LocString DisplayName { get { return Localizer.DoStr("Wood Cart DarkBlue"); } }
        public Type RepresentedItemType { get { return typeof(WoodCartDarkBlueItem); } }
