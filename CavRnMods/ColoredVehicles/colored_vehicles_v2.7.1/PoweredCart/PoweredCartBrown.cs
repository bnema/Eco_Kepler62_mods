namespace Eco.Mods.TechTree
{
    ...
    public class PaintPoweredCartBrownRecipe : RecipeFamily
    {
        public PaintPoweredCartBrownRecipe()
        {
            ...
            {
                new Recipe(
                    "Paint Powered Cart Brown",
                    Localizer.DoStr("Paint Powered Cart Brown"),
                    ...
                    new CraftingElement<PoweredCartBrownItem>()
                )
            };
            this.ExperienceOnCraft = 0.1f;  
            this.LaborInCalories = CreateLaborInCaloriesValue(250, typeof(BasicEngineeringSkill)); 
            this.CraftMinutes = CreateCraftTimeValue(typeof(PaintPoweredCartBrownRecipe), 5, typeof(BasicEngineeringSkill));    

            this.Initialize(Localizer.DoStr("Paint Powered Cart Brown"), typeof(PaintPoweredCartBrownRecipe));
    ...
    public partial class PoweredCartBrownObject : PhysicsWorldObject, IRepresentsItem
    {
